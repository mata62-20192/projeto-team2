...
public class Historico {
	...
	public void imprimirTXT() {
		...
		System.out.println("Carga horária obrigatória: " + calcularCargaHorariaObrigatorias());
		System.out.println("Carga horária optativas: " + calcularCargaHorariaOptativas());
	...
	public void imprimirHTML() {
		...
		System.out.println("<tr><td>Carga horária obrigatória: " + calcularCargaHorariaObrigatorias() + "</td></tr>");
		System.out.println("<tr><td>Carga horária optativas: " + calcularCargaHorariaOptativas() + "</td></tr>");
