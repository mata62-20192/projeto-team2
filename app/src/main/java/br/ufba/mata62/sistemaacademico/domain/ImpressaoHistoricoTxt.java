...
public class ImpressaoHistoricoTxt extends ImpressaoHistoricoTemplate {
	...
	public void render(Historico historico) {
		...
		System.out.println(
				"Carga horária obrigatória: " + HistoricoService.calcularCargaHorariaObrigatorias(historico));
