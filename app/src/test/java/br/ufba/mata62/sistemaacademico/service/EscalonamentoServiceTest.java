...
class EscalonamentoServiceTest {
	...
	@Test
	void testOrdenar() {
		EscalonamentoService service = new EscalonamentoService();
		service.setEscalonamentoStrategy(new EscalonamentoSemestreStrategy());
		service.ordenar(new ArrayList<Aluno>(Universidade.getAlunos().values()));
